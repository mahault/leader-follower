...
\begin{figure}[t]
\centering
\subfloat[Single-run cross-correlations]{\includegraphics[width=\columnwidth]{lagged_correlations.png}\label{fig:cc_single}}\\[6pt]
\subfloat[Multi-run validation ($N=50$)]{\includegraphics[width=\columnwidth]{multirun_crosscorrelations.png}\label{fig:cc_multi}}
...
\begin{figure}[t]
\centering
\subfloat[Pressure crossover]{\includegraphics[width=\columnwidth]{pressure_crossover.png}\label{fig:pressure}}\\[6pt]
\subfloat[Energy staircase]{\includegraphics[width=\columnwidth]{staircase_pattern.png}\label{fig:staircase}}
