...
% To use the IOP template on Overleaf, open the template at:
%   https://www.overleaf.com/latex/templates/template-for-iop-publishing-journals/dbftskdgszdz
% and paste this content in, changing \documentclass to {iopart}.
% ============================================================================
...
% Allow generous float placement to avoid blank pages
...
\author[1]{Pranay Vaddepalli\thanks{Corresponding author. E-mail: pranay.vaddepalli@student.shu.ac.uk}}
\author[2]{Fethi Candan}
\author[1]{Alejandro Jimenez Rodriguez}
\author[1]{Mahault Albarracin}
\affil[1]{Department of Computing, Sheffield Hallam University, Sheffield, UK}
\affil[2]{Department of Robotics, Erciyes University, Kayseri, Turkey}
...
Existing multi-agent coordination approaches address aspects of this challenge. Consensus-based methods \cite{olfati2004,ren2005} provide mathematical convergence guarantees but assume static topologies. Market mechanisms \cite{dias2006} enable flexible task allocation but lack the persistent social memory that supports recovery from disruption. Stigmergic approaches \cite{dorigo2000,theraulaz1999} produce emergent coordination through environmental modification but offer limited social complexity. Hierarchical architectures \cite{werger2000,chen2020} impose leader-follower structures by design but cannot model leadership emergence. None of these approaches implements the circular causal architecture that characterises biological social resilience.
...
\begin{figure}[htbp]
\centering
\subfloat[Single-run cross-correlations]{\includegraphics[width=0.9\columnwidth]{lagged_correlations.png}\label{fig:cc_single}}\\[4pt]
\subfloat[Multi-run validation ($N=50$)]{\includegraphics[width=0.9\columnwidth]{multirun_crosscorrelations.png}\label{fig:cc_multi}}
...
\begin{figure}[htbp]
\centering
\subfloat[Pressure crossover]{\includegraphics[width=0.9\columnwidth]{pressure_crossover.png}\label{fig:pressure}}\\[4pt]
\subfloat[Energy staircase]{\includegraphics[width=0.9\columnwidth]{staircase_pattern.png}\label{fig:staircase}}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\columnwidth]{evolution_bond_matrix.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\columnwidth]{scenario_resource_scarcity.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\columnwidth]{scenario_leader_removal.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\columnwidth]{fig_14_ate_forward_normalized.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\columnwidth]{fig_14_do_operator_normalized.png}
...
\bibitem{wilson2022}
Wilson S~P and Prescott T~J 2022 Scaffolding layered control architectures through constraint closure: insights into brain evolution and development \emph{Phil. Trans. R. Soc.} B \textbf{377} 20200519
...
\bibitem{dorigo2000}
Dorigo M, Bonabeau E and Theraulaz G 2000 Ant algorithms and stigmergy \emph{Future Gener. Comput. Syst.} \textbf{16} 851--871
...
\bibitem{verma2021}
Verma J~K and Ranga V 2021 Multi-robot coordination analysis, taxonomy, challenges and future scope \emph{J. Intell. Robot. Syst.} \textbf{102} 10
...
\bibitem{trianni2015}
Trianni V and Campo A 2015 Fundamental collective behaviors in swarm robotics \emph{Springer Handbook of Computational Intelligence} ed J~Kacprzyk and W~Pedrycz (Berlin: Springer) pp 1377--1394
...
\bibitem{jolles2015}
Jolles J~W \emph{et al} 2015 The role of social attraction and its link with boldness in the collective movements of three-spined sticklebacks \emph{Anim. Behav.} \textbf{99} 147--153
...
\bibitem{watson2016}
Watson R~A \emph{et al} 2016 Evolutionary connectionism: algorithmic principles underlying the evolution of biological organisation in evo-devo, evo-eco and evolutionary transitions \emph{Evol. Biol.} \textbf{43} 553--581

\bibitem{filella2018}
Filella A, Nadal F, Sire C, Kanso E and Eloy C 2018 Model of collective fish behavior with hydrodynamic interactions \emph{Phys. Rev. Lett.} \textbf{120} 198101

\bibitem{moorthy2022}
Moorthy S and Joo Y~H 2022 Distributed leader-following formation control for multiple nonholonomic mobile robots via bioinspired neurodynamic approach \emph{Neurocomputing} \textbf{492} 308--321

\bibitem{zhang2019}
Zhang C \emph{et al} 2019 SA-IGA: a multiagent reinforcement learning method towards socially optimal outcomes \emph{Auton. Agents Multi-Agent Syst.} \textbf{33} 403--429
